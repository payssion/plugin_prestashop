	...
	public function install()
	{
		if (!parent::install()
				...
				OR !Configuration::updateValue(self::PAYSSION_PM_OPTIONS, 
						'bitcoin|cashu|onecard|rixty|paysafecard|sofort|qiwi|yamoney|yamoneyac|sberbank_ru|alfaclick_ru|neosurf|trustpay|dineromail_ar|boleto_br|bancodobrasil_br|bradesco_br|caixa_br|itau_br|elo_br|hipercard_br|visa_br|mastercard_br|dinersclub_br|americanexpress_br|banamex_mx|bancomer_mx|oxx_mx|santander_mx|redpagos_uy|bancochile_cl|redcompra_cl|molpay|maybank2u_my|dragonpay_ph')
				OR !Configuration::updateValue(self::PAYSSION_PM_SURCHARGE, '0|0|0|0|0|0')
				OR !Configuration::updateValue(self::PAYSSION_PM_NAME, 
						'Bitcoin|CashU|OneCard|Rixty|Paysafecard|SOFORT|Qiwi|Yandex.Money|Bank Card (Yandex.Money)|Sberbank|Alfa-Click|Neosurf|trustpay|Dinero Mail - Efectivo Argentinal|Boleto|Banco do Brasil|Bradesco|Caixa Brazil|Itau|Elo Brazil|Hipercard Brazil|Visa Brazil|Mastercard Brazil|Dinersclub Brazil|American Express Brazil|Banamex|Bancomer(BBVA)|Oxxo|Santander Mexico|Redpagos|Banco de Chile|RedCompra|MOLPay|Maybank2u|Dragonpay')
